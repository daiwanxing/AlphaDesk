export const SEC_USER_AGENT = "InvestorEventTracker/0.1 (personal research; contact@localhost)";
...
export const MAG7_BY_TICKER = Object.fromEntries(MAG7.map((c) => [c.ticker, c])) as Record<
  (typeof MAG7)[number]["ticker"],
  (typeof MAG7)[number]
>;

export function getIrUrl(ticker: string): string | undefined {
  return MAG7_BY_TICKER[ticker as (typeof MAG7)[number]["ticker"]]?.irUrl;
}
