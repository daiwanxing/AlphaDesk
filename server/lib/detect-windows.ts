/** AI 解读检测节奏（设计 §3.1.1）；与 cloudfunctions/detect-new-materials/detect-windows.ts 保持同步 */

export type DetectMode = "dense" | "daily" | "idle";
...
export function resolveDetectMode(input: ResolveDetectModeInput): DetectMode {
